...
const Chat = () => {
  return (
    ...
    <div className="w-full h-[100vh]  p-2 relative max-w-[600px] mx-auto chats">
        <div className="w-full h-full bg-[#f0f3f6] rounded-xl overflow-hidden relative">
            <div className="w-full h-16 border-b-2 px-5 flex items-center gap-3  bg-[#f0f3f6]  absolute top-0 z-10">
                ...
                <h1 className='font-bold text-lg pb-2'>Rupesh.</h1>
                <p className='text-sm text-zinc-400 absolute bottom-2 left-[70px]'>rupeshkw9334@gmail.com</p>
            </div>
            <div className="w-full h-full  py-[70px] px-2 overflow-y-scroll  side">
            <Bubble/>
            <Bubble/>
            <Bubble/>
            <Bubble/>
