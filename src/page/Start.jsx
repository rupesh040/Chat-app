...
const Start = () => {
  ...
  return (
    <div className='w-[100vw] h-[100vh] flex justify-center items-center flex-col overflow-hidden'>
        {!show?<h1 className='absolute z-[-1] font-bold top-0 text-center text-[300px] text-zinc-400 name max-[1080px]:text-[250px] max-[900px]:text-[200px] max-[900px]:top-10 max-[780px]:text-[150px] max-[780px]:top-20 max-[680px]:text-[100px]'>Rupesh.</h1>:""}
        ...
        <div className={` w-[300px] h-[555px] rounded-[50px] bg-black flex justify-center items-center iphone ${show?"LoginIphone":""} `}>
          <div className={`${show?"bg-[#f4f4f4]":""}  w-[280px] h-[535px] rounded-[40px] bg-[#f4f4f4] flex justify-center items-center relative `}>
           ...
           <div className={` ${show?"hidden":" z-0"} absolute top-0 opacity-55 blur-[50px] w-full  h-20 bg-purple-500 rotate-[-40deg] `} ></div>
           <div className={`${show?"hidden":" z-0"} absolute top-32 left-5 opacity-25 blur-[60px] w-full  h-20 bg-blue-500 rotate-[-40deg]`}></div>
           {/* auth add  */}
           {/* scale-[.7] translate-y-20 */}
           {show?

            <div className=" scale-[.7] translate-y-0">
            <Auth/>
           </div>:<></>
           }
